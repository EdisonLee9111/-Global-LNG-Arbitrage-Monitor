...
| --- | --- | --- | --- | --- |
| HH price | market_data.iloc[-1]['HH_Price'] -> 3.09 (data_loader.fetch_henry_hub) | Market risk | Daily moves, mean reversion | Must |
| JKM price | market_data.iloc[-1]['JKM_Price'] -> 21.42 (synthetic: TTF + premium + seasonal + noise) | Market risk | Daily moves, strong seasonality | Must |
| TTF price | market_data.iloc[-1]['TTF_Price'] -> 18.85 (data_loader.fetch_ttf) | Market risk | Daily moves | Must |
...
| USD/JPY | market_data.iloc[-1]['USD_JPY'] -> 157.56 (data_loader.fetch_usd_jpy) | Market risk | Daily macro-driven moves | Must |
