...
| --- | --- | --- | --- | --- |
| HH price | market_data.iloc[-1]['HH_Price'] -> 3.10 (data_loader.fetch_henry_hub) | Market risk | Daily moves, mean reversion | Must |
| JKM price | market_data.iloc[-1]['JKM_Price'] -> 10.40 (synthetic: TTF + premium + seasonal + noise) | Market risk | Daily moves, strong seasonality | Must |
| TTF price | market_data.iloc[-1]['TTF_Price'] -> 9.20 (data_loader.fetch_ttf) | Market risk | Daily moves | Must |
...
| USD/JPY | market_data.iloc[-1]['USD_JPY'] -> 149.50 (data_loader.fetch_usd_jpy) | Market risk | Daily macro-driven moves | Must |
