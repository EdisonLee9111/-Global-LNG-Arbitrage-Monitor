...
| --- | --- | --- | --- | --- |
| HH price | market_data.iloc[-1]['HH_Price'] -> 3.48 (data_loader.fetch_henry_hub) | Market risk | Daily moves, mean reversion | Must |
| JKM price | market_data.iloc[-1]['JKM_Price'] -> 13.10 (synthetic: TTF + premium + seasonal + noise) | Market risk | Daily moves, strong seasonality | Must |
| TTF price | market_data.iloc[-1]['TTF_Price'] -> 10.53 (data_loader.fetch_ttf) | Market risk | Daily moves | Must |
