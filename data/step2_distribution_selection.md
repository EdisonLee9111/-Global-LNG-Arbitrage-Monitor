...
| --- | --- | --- | --- | --- | --- |
| HH price | OU mean-reversion (primary), Lognormal/GBM (fallback) | Price > 0 | S0=2.96, kappa=2.4158, theta=3.00, sigma_ou=0.2318; mu_gbm=-0.000030/day, sigma_gbm=0.047847/day | Project from t0 to discharge horizon T=30-60 days | Use OU transition for gas-specific mean reversion; keep GBM as stress/fallback |
| TTF price | OU mean-reversion (primary), Lognormal/GBM (fallback) | Price > 0 | S0=9.18, kappa=0.0300, theta=9.04, sigma_ou=0.2107; mu_gbm=0.001150/day, sigma_gbm=0.033192/day | Project from t0 to discharge horizon T=30-60 days | Use OU transition for gas-specific mean reversion; keep GBM as stress/fallback |
| JKM price | OU mean-reversion (primary), Lognormal/GBM (fallback) | Price > 0 | S0=10.51, kappa=0.0300, theta=10.50, sigma_ou=0.2846; mu_gbm=0.000549/day, sigma_gbm=0.038004/day | Project from t0 to discharge horizon T=30-60 days | Use OU transition for gas-specific mean reversion; keep GBM as stress/fallback |
