...
| --- | --- | --- | --- | --- | --- |
| HH price | OU mean-reversion (primary), Lognormal/GBM (fallback) | Price > 0 | S0=3.48, kappa=0.0070, theta=3.17, sigma_ou=0.0452; mu_gbm=0.000306/day, sigma_gbm=0.014696/day | Project from t0 to discharge horizon T=30-60 days | Use OU transition for gas-specific mean reversion; keep GBM as stress/fallback |
| TTF price | OU mean-reversion (primary), Lognormal/GBM (fallback) | Price > 0 | S0=10.53, kappa=0.0321, theta=10.40, sigma_ou=0.0896; mu_gbm=0.000105/day, sigma_gbm=0.008594/day | Project from t0 to discharge horizon T=30-60 days | Use OU transition for gas-specific mean reversion; keep GBM as stress/fallback |
| JKM price | OU mean-reversion (primary), Lognormal/GBM (fallback) | Price > 0 | S0=13.10, kappa=0.0959, theta=12.19, sigma_ou=0.2772; mu_gbm=0.000315/day, sigma_gbm=0.022227/day | Project from t0 to discharge horizon T=30-60 days | Use OU transition for gas-specific mean reversion; keep GBM as stress/fallback |
